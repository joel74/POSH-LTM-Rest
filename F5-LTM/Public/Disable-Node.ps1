        ...
        switch($PSCmdLet.ParameterSetName) {
            ...
            InputObject {
                ...
                foreach($member in $InputObject) {
                    ...
                    Invoke-RestMethodOverride -Method PATCH -Uri "$URI" -Credential $F5Session.Credential -Body $JSONBody -ErrorMessage "Failed to disable node $($member.Name)." -AsBoolean
                }
            }
        }
    }
